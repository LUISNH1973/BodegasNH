            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- to get an API token!-->
                    <form method="POST" action="{{ route('password.email') }}" id="contactForm" data-sb-form-api-token="API_TOKEN">
                         ...
                         @csrf
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl disabled" id="submitButton" type="submit">{{ __('Recuperar contraseña') }}/button>  <div class="row mb-0">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                           Somos una pequeña empresa dedicada a la elaboración de vinos tintos ecológicos en una zona compleja como es la campiña sevillana
                            <a href="https://www.bodegascampillo.com">BODEGAS NH</a>
                        </p>
                    </div>
                </div>
            </div>
